...
'''
cd "c:\MY_PROJECTS\MauryaHub\MauryaHub"
git init
git remote add origin https://github.com/22f3000982/MauryaHub.git
git add app.py
git commit -m "Fix course data disappearing by prioritizing Supabase"
git branch -M main
